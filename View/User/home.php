<div id="post1" style="display:flex;margin-top:5%;">
          ...
          <img  src="<?php echo $post_image ?>" id="travel"><p  id="T1">
               <?php echo $ROW_USER['FirstName']." ".$ROW_USER['LastName']?><br><span style="color:#999; size:10px;font-size:13px;"><?php echo $ROW['date']?></span><br>
            ...
            <a href="" style="color: blue;"><i  class="fa fa-comments-o"style="font-size:15px;color:#f731c6;">Comments</i></a>
